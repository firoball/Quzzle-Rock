...
namespace Assets.Scripts.Classes
{
    ...
    public class ModeStatistics
    {
        ...
        public void Save(string mode)
        {
            ...
            PlayerPrefs.SetInt("mode." + mode + ".gamesAborted", m_gamesAborted);
            ...
            PlayerPrefs.SetInt("mode." + mode + ".bestScore", m_bestScore);
        ...
        public void Load(string mode)
        {
            ...
            m_gamesAborted = PlayerPrefs.GetInt("mode." + mode + ".gamesAborted", 0);
            ...
            m_bestScore = PlayerPrefs.GetInt("mode." + mode + ".bestScore", 0);
